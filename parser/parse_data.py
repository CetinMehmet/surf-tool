...
class ParseData:
    ...
    def __construct_metric_path(self, metric_dir: list, pq_path: str):
        """
    ...
    def parse_data(self):
        ...
        node_parquets = self.__construct_metric_path(self.node_dir, self.pqEncrypted)
        gpu_parquets = self.__construct_metric_path(self.gpu_dir, self.pqNvidiaEncrypted)
